        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AspectRatioColumn = table.Column<string>(nullable: true),
                    BasePriceColumn = table.Column<string>(nullable: true),
                    BrandColumn = table.Column<string>(nullable: true),
                    DiameterColumn = table.Column<string>(nullable: true),
                    DimensionColumn = table.Column<string>(nullable: true),
                    DiscountPercentage = table.Column<decimal>(nullable: false),
                    EANColumn = table.Column<string>(nullable: true),
                    ...
                    LoadIndexSpeedRatingColumn = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    ProfilColumn = table.Column<string>(nullable: true),
                    ReferenceColumn = table.Column<string>(nullable: true),
                    SheetIndex = table.Column<int>(nullable: false),
                    SizeFormat = table.Column<int>(nullable: false),
                    StartLineNumber = table.Column<int>(nullable: false),
                    WidthColumn = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dimater = table.Column<int>(nullable: false),
                    ...
                    LoadIndexSpeedRating = table.Column<string>(nullable: true),
